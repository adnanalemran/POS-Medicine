...
class SupplierCategoryController extends Controller
{
    ...
    {
        $data = SupplierCategory::orderBy('id', 'DESC')->get();
     ...
     *
     * @param  \App\Models\SupplierCategory  $drugGenericName
     * @return \Illuminate\Http\Response
     */
    public function show(SupplierCategory $drugGenericName)
    {
        //
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validator->fails()) {
            ...
            $data = $request->all();
            $brand = SupplierCategory::find($id);
