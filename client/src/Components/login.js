                                    ...
                                    <form className="auth-login-form mt-2" onSubmit={submitForm}>
                                        ...
                                        <div className="mb-1">
                                            ...
                                            <div className="input-group input-group-merge form-password-toggle">
                                                <input type="password" className="form-control form-control-merge" name="password" onChange={e => setPassword(e.target.value)} tabIndex={2} placeholder="············" aria-describedby="login-password" autoFocus />
                                      ...
                                      {
                                        !loading ?  <input type="submit" value="Sign In" className="btn btn-primary w-100 mt-4"/> :
                                        <input value='Your request is processing' className="btn btn-light w-100 mt-4" />
