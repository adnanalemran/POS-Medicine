...
function EditSupplierRequisition() {
    ...
    const confirmRequisition = () => {
        Swal.fire({
            title: 'Are you sure?',
            text: "You want to confirm this requisition!",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            ...
            if (result.isConfirmed) {
                ...
                // const newCart = existCart.filter((pd) => pd.id !== item.id);
                // setCart(newCart);
                http.get(`/confirm-requisition/${id}`).then(res => {
                    // console.log("certificate row Detele");
                ...
                Swal.fire(
                    {
                        ...
                        icon: 'success',
                        title: 'Send!',
                        html: 'Your requisitions has been confirmed.',
                        timer: 2500
                    }
                )
            }
...
export default EditSupplierRequisition
