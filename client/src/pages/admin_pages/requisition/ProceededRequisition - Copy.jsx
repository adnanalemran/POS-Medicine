...
function ProceededRequisition() {
    ...
    const [proceeded_req, setProceededReq] = useState();
    ...
    return (
        <div className="page-content">
            ...
            <form  onSubmit={submitFormData}>
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        ...
                                        <div className="row mb-1">
                                            ...
                                            <div className="col-sm-7">
                                                <select className="form-select form-select-sm" name="requisition_category_id" onChange={handleInput} disabled
                                        ...
                                        <div className="row mb-1">
                                            ...
                                            <div className="col-sm-7">
                                                <input type="date" name="expected_date_of_delivery" onChange={handleInput} disabled
                                        ...
                                        <div className="row mb-1">
                                            ...
                                            <div className="col-sm-7">
                                                <input type="date" onChange={handleInput} name="date_and_time" value={form_data.date_and_time}
                                                       className="form-control form-control-sm" id="exampleInputUsername2" disabled
                                        ...
                                        <div className="row mb-1">
                                            ...
                                            <div className="col-sm-7">
                                                <select className="form-select form-select-sm" name="test_sample" onChange={handleInput}
                                                        value={form_data.test_sample} disabled
                                                        id="status">
                                                    <option selected="" disabled="">Select</option>
                                        ...
                                        <div className="row mb-1">
                                            ...
                                            <div className="col-sm-7">
                                                <select className="form-select form-select-sm" name="supplier_id" onChange={handleInput}
                                                        value={form_data.supplier_id} disabled
                                                        id="status">
                                                    <option selected="" disabled="">Select</option>
                                        ...
                                        <div className="row mb-1">
                                            ...
                                            <div className="col-sm-7">
                                                <select className="form-select form-select-sm" name="delivery_mode" onChange={handleInput}
                                                        value={form_data.delivery_mode} disabled
                                                        id="status">
                                                    <option selected="" disabled="">Select</option>
                                        ...
                                        <div className="row mb-1">
                                            ...
                                            <div className="col-sm-7">
                                                <select className="form-select form-select-sm" name="payment_mode" onChange={handleInput}
                                                        value={form_data.payment_mode} disabled
                                                        id="status">
                                                    <option selected="" disabled="">Select</option>
                                                ...
                                                <div className="row">
                                                    <div className="col-md-6">
                                                        <div className="form-check mb-2">
                                                            <input type="checkbox" disabled className="form-check-input" name="recurring_order" onClick={()=> grid_view()} id="checkDefault" onChange={handleInput} value="yes" />
                                                        ...
                                                        <div className={isActive ? "row mb-1" : "d-none row mb-1"}>
                                                            ...
                                                            <div className="col-sm-7">
                                                                <select className="form-select form-select-sm" name="requisition_frequency_id" onChange={handleInput}
                                                                        value={form_data.requisition_frequency_id} disabled
                                                                        id="status">
                                                                    <option selected="" disabled="">Select</option>
                                                                    {
                                                        ...
                                                        <div className={isActive ? "row mb-1" : "d-none row mb-1"}>
                                                            ...
                                                            <div className="col-sm-7">
                                                                <input type="date" name="frequency_start_date" onChange={handleInput}
                                                                       value={form_data.frequency_start_date} disabled
                                                                       className="form-control form-control-sm" id="exampleInputUsername2"
                                                                       placeholder="64854645"/>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className={isActive ? "row" : "d-none row"}>
                                                            ...
                                                            <div className="col-sm-7">
                                                                <input type="date" name="frequency_end_date" onChange={handleInput}
                                                                       value={form_data.frequency_end_date} disabled
                                                                       className="form-control form-control-sm" id="exampleInputUsername2"/>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div className="col-md-6">
                                                        <div className="mb-3">
                                                            ...
                                                            <textarea name="description" name="special_instruction" onChange={handleInput}
                                                                      value={form_data.special_instruction} disabled
                                ...
                                <table className="table table-striped table-striped table-hover mt-3">
                                    ...
                                    cart.map((item, i) => (
                                        <tr key={i} className="border-bottom">
                                            ...
                                            <td width={"9%"}>
                                                <select className="form-select form-select-sm" value={item.pktSize} disabled
                                            ...
                                            <td width={"7%"}>
                                                <input className="form-control form-control-sm" name="size" disabled
                                            ...
                                            <td width={"9%"}>
                                                <select value={item.unit} disabled onChange={(e) => unitHandler(item, e)} aria-label=".form-select-sm example" className="form-select form-select-sm">
                                            ...
                                            <td width={"10%"}>
                                                <input className="form-control form-control-sm"
                                                       defaultValue={item.req_unit} disabled
                ...
                {
                    (form_data.purchase_order_no === null && form_data.requisition_status === "confirmed") || (form_data.purchase_order_no === null && form_data.requisition_status === "approved") ?
                        <button type="button" onClick={() => convertToPo()} className="btn btn-sm btn-success float-end text-uppercase mt-3 me-2">
