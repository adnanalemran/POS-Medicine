                            ...
                            <table>
                                <tbody>
                                    <tr className="bg-light">
                                        ...
                                        <td>Supplier</td>
                                        <td>Purchase Type</td>
                                        <td className='text-end'>Purchase Price</td>
                                            ...
                                            return (
                                                <>
                                                    <tr key={i}>
                                                        ...
                                                        <td width='10%' className='text-start text-capitalize'>{item?.payment_type}</td>
                                                        ...
                                                        <td width='10%' className='text-end'>{((parseFloat(item?.total_bill_amount || 0) - parseFloat(item?.special_discount || 0)) || 0).toFixed(2)}</td>
                                                    </tr>
                                                </>)
                                        }
