                            ...
                            <table>
                                <tbody>
                                    <tr className="bg-light">
                                        ...
                                        <td className='text-end'>S Amount</td>
                                            ...
                                            return (
                                                <>
                                                    <tr key={i}>
                                                        ...
                                                        <td width='11%' className='text-start'>{item?.invoice_no}</td>
                                                        <td width='15%' className='text-start'>{item?.member?.member_name}</td>
                                                        <td></td>
                                                        <td></td>
                                                        <td></td>
                                                        <td width='8%' className='text-end'>{num(item?.sub_total)}</td>
                                                        <td width='5%' className='text-end'>{num(item?.special_discount)}</td>
                                                        <td></td>
                                                        <td width='7%' className='text-end'>{((parseFloat(item?.grand_total || 0) - parseFloat(item?.special_discount || 0)) || 0).toFixed(2)}</td>
                                                    </tr>
                                                    {
                                                        item?.details?.map((pd, j) => {
                                                            ...
                                                            return (
                                                                <tr key={pd.id}>
                                                                    ...
                                                                    <td width='5%' className='text-end'>{((num(pd?.total_price) / pd?.qty) || 0).toFixed(2)}</td>
                                                                    <td></td>
                                                                    <td></td>
                                    ...
                                    <tr>
                                        <td colSpan={10} className='text-end fw-bold'> Sub Total : </td>
                                        <td className='text-end'>{reportData.reduce((total, current) => total + parseFloat(current.sub_total || 0), 0).toFixed(2)}</td>
                                    </tr>
                                    <tr>
                                        <td colSpan={10} className='text-end fw-bold'> Discount Total : </td>
                                    ...
                                    <tr>
                                        ...
                                        <td className='text-end'>{(reportData.reduce((total, current) => total + parseFloat(current.sub_total || 0), 0) - reportData.reduce((total, current) => total + parseFloat(current?.special_discount || 0), 0)).toFixed(2)}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
