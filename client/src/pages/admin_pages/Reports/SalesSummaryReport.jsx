                            ...
                            <table className='mt-2'>
                                <tbody>
                                    <tr className='bg-light'>
                                        ...
                                        <td>Invoice No</td>
                                        <td>Member</td>
                                        <td className='text-end'>Sales Amount</td>
                                        ...
                                        reportData.map((item, i) =>
                                            <>
                                                <tr key={i}>
                                                    ...
                                                    <td width='7%' className='text-end'>{((parseFloat(item?.grand_total) - parseFloat(item?.special_discount)) || 0).toFixed(2)}</td>
                                                </tr>
                                            </>)
                                    }
                                    <tr>
