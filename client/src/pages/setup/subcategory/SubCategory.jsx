...
function SubCategory() {
    ...
    const columns = [
        ...
        {
            title: "Sub Category Id", field: `id`,
            cellStyle: {
                textAlign: "center",
            },
        },
        ...
        {
            title: "Photo", field: `photo`, render: (row) =><div className='text-center'>{row.photo !== null ? <img src={`${global.img_url}/files/subcategory/${row.photo}`} width="70" alt="No Image" /> : <img src={`${global.img_url}/files/no_images.png`} width="70px" alt="No Image" />}</div>
        },
        {
